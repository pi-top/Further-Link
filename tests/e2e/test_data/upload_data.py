directory = {
    ...
    "files": {
        "cereal.csv": {
            "type": "url",
            "content": {
                "url": "https://backend.pi-top.com/api/v3/Containers/further-files/download/2a9a1e12-b71c-4f20-84b2-f205e9dc16fd.csv",
...
directory_with_project = {
    ...
    "files": {
        ...
        "project.cfg": {
            "type": "text",
            "content": {
                "text": "[project]\ntitle=my project\nstart=python3 -B print.py",
            },
        },
        "print.py": {
            "type": "text",
            "content": {
                "text": "print('this is a project!')\n",
            },
        },
    },
}
